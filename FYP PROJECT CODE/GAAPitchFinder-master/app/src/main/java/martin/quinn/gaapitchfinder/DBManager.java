...
public class DBManager {
    ...
    private static class MyDatabaseHelper extends SQLiteOpenHelper {
        ...
        // when the app is initially created the tabe creates and inserts will execute.
        @Override
        ...
        //When upgrading the database the table will be dropped to cater for the new
        @Override
    ...
    // gets club names based on the county pressed from "CountyDisplay" to "AllClubDisplay.java"
    ...
    // searches the database for a club with the name like a search query from "SearchActivity.java"
    ...
    // finds the clubs that match the county_id from "CountyDisplay.java"
    ...
    // for inserting a club if there was a feature in future version to
    // insert a users own club or location / event
    ...
    //for development use to update an inserted or preloaded club
    ...
    // for a future version to delete a club
